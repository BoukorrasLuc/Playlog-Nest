...
export class ScrappingService {
  ...
  async onApplicationBootstrap() {
    await this.scrapeEbayVideoGamesManualOnly();
  }

  // async scrapeEbayVideoGamesComplete() {
  //   try {
  ...
  async scrapeEbayVideoGamesManualOnly() {
    try {
      // Fetch all games from the database
      const games: Game[] = await this.gameService.getAll();
      ...
      for (const game of gamesRandomOrder) {
        ...
        if (game.zone === 'PAL' || game.zone === 'JAP') {
          ...
          try {
            ...
            if (noResultsFound) {
              console.log("🚀 ~ ScrappingService ~ scrapeEbayVideoGamesManualOnly ~ noResultsFound:", noResultsFound)
              continue;
            }
            ...
            // If data was found, transform it
            if (data.length > 0) {
              console.log("🚀 ~ ScrappingService ~ scrapeEbayVideoGamesComplete ~ data:", data)
              const item = data[0];
...
// result of scraping video game instructions alone for future analysis

// 🚀 ~ ScrappingService ~ scrapeEbayVideoGamesComplete ~ data: [
//   {
//     price: '8,00 EUR',
//     name: 'nintendo game cube final fantasy crystal chronicles - notice seule',
//     date: ' 30 janv. 2024',
//     typeSold: null,
//     country: null
//   }
...
//   {
//     price: '4,00 EUR',
//     name: 'notice seule playstation 1 ps1 - mode d’emploi fr die hard trilogy',
//     date: ' 7 janv. 2024',
//     typeSold: null,
//     country: null
//   }
...
//   {
//     price: '4,90 EUR',
//     name: 'notice seule nintendo game boy f1 race fah',
//     date: ' 27 janv. 2024',
//     typeSold: null,
//     country: null
//   }
